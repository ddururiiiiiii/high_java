...
//타이핑치지마라. 읽고 이해해라.
	 ...
	 * 		하지만, 두 객체가 같으면 반드시 hashCode가 같아야 한다. 이럴때 equals 또 쓰라고.
	 * 4. equals()메서드를 override하면 반드시 hashCode()메서드도 override해야 한다.
	 * 5. hashCode()는 기본적으로 Heap에 있는 각 객체에 대한 메모리 주소 매핑 정보를 기반드로
	...
	public static void main(String[] args) {
		...
		set.add(p1);
		System.out.println("add(p2) 성공여부: "+set.add(p2));
		//hashSet이기때문에 hashcode를 잽싸게 체크해보고 같아서 안넣었다. 
